...
def banner(z):
	for e in z + '\n':
		sys.stdout.write(e)
		sys.stdout.flush()
		time.sleep(00000000000000000000000000.01)
...
def hello(z):
	for e in z + '\n':
		sys.stdout.write(e)
		sys.stdout.flush()
		time.sleep(00000000000000000000000000000000000000.1)
hello("\033[1;32m tools installer v0.1 creat by RaMsY")
def repo_check(sources_list):
	if os.path.isfile(os.getenv("PREFIX")+"/etc/apt/curces.list.d/"+sources_list):
		return True
	return False
